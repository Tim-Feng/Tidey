    ...
    func registerMenuTips() {
        ...
        let tips = [
            ...
            Tip(identifier: "Edit.Actions",
                ...
                text: "Actions are saved instructions for Tidey. For example, you could create an action that opens a new window and then creates a split pane."),
            ...
            Tip(identifier: "Toolbelt.Paste History",
                text: "**Paste History** shows text that you have copied and pasted in Tidey. You can configure it to be saved long term."),
            ...
            Tip(identifier: "Open Interactive Window",
                text: "The Python REPL opens a window running a special Python interpreter that lets you experiment with Tidey’s Python API. You can use `await` at the top level of the interpreter."),
            ...
            Tip(identifier: "Install Python Runtime",
                text: "Tidey’s Python Runtime is a large binary package (hundreds of MBs) that enables the Python API by installing a pre-built Python environment that scripts can use."),
            ...
            Tip(identifier: "Install Shell Integration",
                text: "**Shell Integration** consists of shell scripts that run when you log in. They inform Tidey of where your shell prompt is. This enables dozens of useful features such as command history, directory history, AI features, and more."),
