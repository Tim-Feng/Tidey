...
- (void)tideyHideUnneededMenuItems {
    ...
    NSArray<NSString *> *identifiersToHide = @[
        ...
        @"Broadcast Input.Current Session is Broadcast Source",
        // tmux submenu items
        @"tmux.Dashboard",
        @"tmux.Detach",
        @"tmux.Force Detach",
        ...
        @"Set Named Mark",
        @"Fold Selected Lines",
        @"Fold All Above Cursor",
        @"Clear Buffer",
        @"Clear Instant Replay",
        @"Clear Scrollback Buffer",
        @"Clear to Start of Selection",
        @"Clear to Last Mark",
        // Paste Special submenu items
        @"Paste Special.Advanced Paste\u2026",
        @"Paste Special.Paste Selection",
        @"Paste Special.Paste File Base64-Encoded",
        @"Paste Special.Paste Slowly",
        @"Paste Special.Paste Faster",
        @"Paste Special.Paste Slowly Faster",
        @"Paste Special.Paste Slower",
        @"Paste Special.Paste Slowly Slower",
        ...
        // Replace Selection submenu items
        @"Render Selection Natively",
        @"Replace Selection.Replace with Pretty-Printed JSON",
        @"Replace Selection.Replace with Base 64-Encoded Value",
        @"Replace Selection.Replace with Base 64-Decoded Value",
        // Find submenu – hide advanced items, keep Find/Find Next/Find Previous
        @"Find.Use Selection for Find",
        @"Find.Clear Find",
        @"Find.Find Globally...",
        @"Find.ConvertMatchesToSelections",
        @"Find.Find URLs",
        @"Find.Find All Smart Selection  Matches",
        @"Find.Pick Result To Open",
        @"Find.Filter",
        // Marks and Annotations submenu items
        @"Marks and Annotations.Set Mark",
        @"Marks and Annotations.Jump to Mark",
        @"Marks and Annotations.Next Mark",
        @"Marks and Annotations.Previous Mark",
        ...
        @"Marks and Alerts.Alerts.Alert on Marks in Offscreen Sessions",
        @"Marks and Annotations.Alerts.Show Modal Alert Box",
        @"Marks and Annotations.Alerts.Post Notification",
        @"Marks and Notes.Alerts.Play a Sound",
        ...
        @"Always Show Alerts with Remembered Selections",
        // Toolbelt submenu – hide iTerm2-specific, keep Tidey items
        @"Show Toolbelt",
        @"Set Default Width",
        ...
        // Triggers submenu items
        @"Add Trigger",
        @"Edit Triggers",
        @"Enable Triggers in Interactive Apps",
        @"Triggers.Enable All",
        @"Triggers.Disable All",
        // Move Session submenu items
        @"Move Session to Window",
        @"Move Session to Tab",
        ...
        @"Terminal State.Report Modifiers with CSI u",
        @"Terminal State.Raw Key Reporting",
        @"Terminal State.Disambiguate Escape",
        @"Terminal State.Report All Event Types",
        @"Terminal State.Report Alternate Keys",
        @"Terminal State.Report All Keys as Escape Codes",
        @"Terminal State.Report Associated Text",
        @"Terminal State.Literal Mode",
        @"Terminal State.Emulation Level.VT100",
        @"Terminal State.Emulation Level.VT200",
        @"Terminal State.Emulation Level.VT300",
        @"Terminal State.Emulation Level.VT400",
        @"Terminal State.Emulation Level.VT500",

        // ── Profiles menu (top-level) ──
        @"Open Profiles\u2026",
        @"Press Option for New Window",
        @"Open In New Window",
        @"Change Profile in Arrangement\u2026",
        ...
        @"Edit Tab Title",
        @"Lock Size",
        @"Lock Split Pane Width",
        // Arrangements submenu items
        @"Save Window Arrangement",
        @"Save Current Window as Arrangement",
        @"Load Arrangement from File\u2026",
        // Tab submenu – keep Select Next/Previous Tab
        @"Move Tab to New Window",
        @"Move Tab Left",
        @"Move Tab Right",
        // Split Pane submenu items
        @"Select Split Pane.Select Pane Above",
        @"Select Split Pane.Select Pane Below",
        @"Select Split Pane.Select Pane Left",
        @"Select Split Pane.Select Pane Right",
        @"Select Split Pane.Next Pane",
        @"Select Split Pane.Previous Pane",
        @"Resize Split Pane.Move Divider Up",
        @"Resize Split Pane.Move Divider Down",
        @"Resize Split Pane.Move Divider Left",
        @"Resize Split Pane.Move Divider Right",
        // Window Style submenu items
        @"Window Style.Normal",
        @"Window Style.Full Screen",
        @"Window Style.Maximized",
        @"Window Style.No Title Bar",
        @"Window Style.Centered",
        ...
        // Arrange Windows submenu items
        @"Merge All Windows",
        @"Arrange Windows Horizontally",
        @"Arrange Split Panes Evenly",
        // Resize Window submenu items
        ...
        @"Install Already-Downloaded Python Runtime",
        @"Reveal in Finder",
        @"Import Script",
        @"Export Script",
        @"Script Console",
    ...
    // Titles to hide (items without identifiers: submenus, dynamic items).
    NSArray<NSString *> *titlesToHide = @[
        @"Toggle Key Recording",
        @"Replay Recorded Keys",
        @"Install Shell Integration",
        // Top-level menus to hide entirely
        @"Scripts",
        @"Profiles",
        // Shell submenus without identifiers
        @"Broadcast Input",
        @"tmux",
        @"ssh",
        @"Print",
        @"Archives",
        // Edit submenus without identifiers
        @"Paste Special",
        @"Replace Selection",
        @"Marks and Annotations",
        @"Named Marks",
        // Session submenus without identifiers
        @"Triggers",
        @"Move Session",
        @"Log",
        @"Terminal State",
        @"Buried Sessions",
        // Window submenus without identifiers
        @"Arrangements",
        @"Window Style",
        @"Arrange Windows",
        @"Resize Window",
        @"Split Pane",
        @"Move Tab",
        // Archives submenu items (no identifiers)
        @"Save Archive of Current Session\u2026",
        @"Restore Archive\u2026",
    ];
...
- (void)tideyCheckShellIntegrationInstallation {
    BOOL isRunningUnitTests = [[NSApplication sharedApplication] isRunningUnitTests];
    if (![TideyApplicationEnvironmentPolicy
            shouldOfferShellIntegrationPromptWithBundleIdentifier:NSBundle.mainBundle.bundleIdentifier
        ...
        // stalls until the runner kills the host. Development builds also must not
        // offer to modify the user's production shell configuration.
        return;
    }
    ...
    TideyShellIntegrationInstallPlan *plan =
        [TideyShellIntegrationConfigWriter installPlanForShell:shell
                                                  environment:[NSProcessInfo processInfo].environment
                                                homeDirectory:homeDir
                                             bashProfileExists:[[NSFileManager defaultManager] fileExistsAtPath:bashProfile]];
    if (!plan) {
        DLog(@"Tidey: Unsupported shell '%@' for auto shell integration install", [shell lastPathComponent]);
        return;
    }

    // Check if the config file already contains the shell integration source line.
    if ([[NSFileManager defaultManager] fileExistsAtPath:plan.configFile]) {
        NSString *contents = [NSString stringWithContentsOfFile:plan.configFile
                                                       encoding:NSUTF8StringEncoding
                                                          error:nil];
        if (contents && [TideyShellIntegrationConfigWriter configContainsInstallationMarkerInContents:contents]) {
            // Already installed — remember and don't ask again.
            [defaults setBool:YES forKey:@"TideyShellIntegrationPrompted"];
            DLog(@"Tidey: Shell integration already present in %@", plan.configFile);
            return;
        }
    }

    // Show the prompt.
    NSString *configFileName = [plan.configFile stringByAbbreviatingWithTildeInPath];
    NSAlert *alert = [[[NSAlert alloc] init] autorelease];
    ...
    if (response == NSAlertFirstButtonReturn) {
        // "Install"
        [self tideyInstallShellIntegrationWithPlan:plan];
        [defaults setBool:YES forKey:@"TideyShellIntegrationPrompted"];
...
- (void)tideyInstallShellIntegrationWithPlan:(TideyShellIntegrationInstallPlan *)plan {
    ...
    NSURL *bundledURL = [[NSBundle mainBundle] URLForResource:@"iterm2_shell_integration"
                                                withExtension:plan.shellExtension];
    if (!bundledURL) {
        DLog(@"Tidey: Could not find bundled iterm2_shell_integration.%@", plan.shellExtension);
        ...
        errAlert.informativeText = [NSString stringWithFormat:
            @"Could not find the bundled shell integration script for %@.", plan.shellExtension];
    ...
    if ([fm fileExistsAtPath:plan.destinationPath]) {
        [fm removeItemAtPath:plan.destinationPath error:nil];
    }
    BOOL copied = [fm copyItemAtURL:bundledURL
                              toURL:[NSURL fileURLWithPath:plan.destinationPath]
                              error:&error];
    if (!copied) {
        ...
        errAlert.informativeText = [NSString stringWithFormat:
            ...
            plan.destinationPath, error.localizedDescription];
        [errAlert addButtonWithTitle:@"OK"];
        [errAlert runModal];
        return;
    }
    ...
    if (![TideyShellIntegrationConfigWriter appendSourceLineForPlan:plan error:&appendError]) {
        DLog(@"Tidey: Failed to append shell integration source line: %@", appendError);
        NSAlert *errAlert = [[[NSAlert alloc] init] autorelease];
        errAlert.messageText = @"Installation Failed";
        errAlert.informativeText = [NSString stringWithFormat:
            @"Could not update %@:\n%@",
            plan.configFile, appendError.localizedDescription];
        [errAlert addButtonWithTitle:@"OK"];
        [errAlert runModal];
        return;
    }

    DLog(@"Tidey: Shell integration installed — script at %@, source line in %@",
