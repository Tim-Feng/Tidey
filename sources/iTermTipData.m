  ...
  return @{
    // Big new features
            @"000": @{ kTipTitleKey: @"Tip of the Day",
                        kTipBodyKey: @"This window shows the Tidey tip of the day. It’ll appear every 24 hours to let you know about new features and hidden secrets. Hit “More Options” to view more tips or to stop getting them altogether." },
            @"0000": @{ kTipTitleKey: @"Shell Integration",
                         kTipBodyKey: @"The big new feature of Tidey version 3 is Shell Integration. Click “Learn More” for all the details.",
                          kTipUrlKey: @"https://tidey.app/tbd" },
            ...
            @"0002": @{ kTipTitleKey: @"Password Manager",
                        kTipBodyKey: @"Did you know Tidey has a password manager? Open it with “Window > Password Manager.” You can define a Trigger to open it for you at a password prompt in “Settings > Profiles > Advanced > Triggers.”" },
            ...
            @"0007": @{ kTipTitleKey: @"Inline Images",
                        kTipBodyKey: @"Tidey can display images (even animated GIFs) inline.",
                        kTipUrlKey: @"https://tidey.app/tbd" },
    ...
    // Big but not new features
            ...
            @"0015": @{ kTipTitleKey: @"Tmux Integration",
                        kTipBodyKey: @"If you use tmux, try running “tmux -CC” to get Tidey’s tmux integration mode. The tmux windows show up as native Tidey windows, and you can use Tidey’s keyboard shortcuts. It even works over ssh!",
                        kTipUrlKey: @"https://gitlab.com/gnachman/iterm2/wikis/TmuxIntegration" },

            @"0016": @{ kTipTitleKey: @"Triggers",
                        kTipBodyKey: @"Tidey can automatically perform actions you define when text matching a regular expression is received. For example, you can highlight text or show an alert box. Set it up in “Settings > Profiles > Advanced > Triggers.”",
                        kTipUrlKey: @"https://tidey.app/tbd" },
    ...
    // Small things
            ...
            @"0036": @{ kTipTitleKey: @"Downloads",
                        kTipBodyKey: @"Tidey can download files by base-64 encoding them. Click “Learn More” to download a shell script that makes it easy.",
                        kTipUrlKey: @"https://tidey.app/tbd" },
            ...
            @"0038": @{ kTipTitleKey: @"Recent Directories",
                        kTipBodyKey: @"Tidey remembers which directories you use the most on each host that has Shell Integration installed. There’s a Toolbelt tool to browse them, and ⌥⌘/ gives you a popup sorted by frequency and recency of use.",
                        kTipUrlKey: @"https://tidey.app/tbd" },
            ...
            @"0040": @{ kTipTitleKey: @"Shell Integration History",
                        kTipBodyKey: @"Install Shell Integration and turn on “Settings > General > Save copy/paste and command history to disk” to remember command history per host across restarts of Tidey.",
                        kTipUrlKey: @"https://tidey.app/tbd" },
            ...
            @"0061" : @{ kTipTitleKey: @"Bell Silencing",
                         kTipBodyKey: @"Did you know? If the bell rings too often, you’ll be asked if you’d like to silence it temporarily. Tidey cares about your comfort." },
            ...
            @"0072": @{ kTipTitleKey: @"Python API",
                        kTipBodyKey: @"You can add custom behavior to Tidey using the Python API.",
                        kTipUrlKey: @"https://tidey.app/tbd" },
            ...
            @"0092": @{ kTipTitleKey: @"Export/Import Settings",
                        kTipBodyKey: @"Easily backup or transfer your Tidey settings using the Export/Import feature in “Settings > General > Settings”." },
            ...
            @"0117": @{ kTipTitleKey: @"AI Chat",
                        kTipBodyKey: @"Tidey now has an AI Chat feature! Use “Window > AI Chats” or “Edit > Explain Output with AI”. The assistant can interact with your terminal (with your permission) and explain command output, adding annotations right in the terminal." },
