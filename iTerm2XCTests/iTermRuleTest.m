...
- (NSArray *)matchingRulesSortedByScoreWithHostname:(NSString *)hostname
    ...
    return [matching sortedArrayUsingComparator:^NSComparisonResult(iTermRule *obj1, iTermRule *obj2) {
        double score1 = [obj1 scoreForHostname:hostname
                                      username:username
                                          path:path
                                           job:job
                                   commandLine:nil
                       expressionValueProvider:nil];
        double score2 = [obj2 scoreForHostname:hostname
                                      username:username
                                          path:path
                                           job:job
                                   commandLine:nil
...
- (void)testScoreMonotonicInWildcardRuleHostLength {
    ...
    double exactScore = [exactHostnameRule scoreForHostname:@"hostname12"
                                                   username:@"george"
                                                       path:@"/path"
                                                        job:@"job"
                                                commandLine:nil
                                    expressionValueProvider:nil];
    double longScore = [longHostnameRule scoreForHostname:@"hostname12"
                                                 username:@"george"
                                                     path:@"/path"
                                                      job:@"job"
                                              commandLine:nil
                                  expressionValueProvider:nil];
    double shortScore = [shortHostnameRule scoreForHostname:@"hostname12"
                                                   username:@"george"
                                                       path:@"/path"
                                                        job:@"job"
                                                commandLine:nil
...
- (void)testScoreMonotonicInWildcardRulePathLength {
    ...
    double exactScore = [exactPathRule scoreForHostname:@"hostname"
                                               username:@"george"
                                                   path:@"/path123"
                                                    job:@"job"
                                            commandLine:nil
                                expressionValueProvider:nil];
    double longScore = [longPathRule scoreForHostname:@"hostname"
                                             username:@"george"
                                                 path:@"/path123"
                                                  job:@"job"
                                          commandLine:nil
                              expressionValueProvider:nil];
    double shortScore = [shortPathRule scoreForHostname:@"hostname"
                                               username:@"george"
                                                   path:@"/path123"
                                                    job:@"job"
                                            commandLine:nil
...
- (void)testScoreMonotonicInWildcardRulePathLength_VeryLongRule {
    ...
    double longScore = [longRule scoreForHostname:@"hostname"
                                         username:@"george"
                                             path:path
                                              job:@"job"
                                      commandLine:nil
                          expressionValueProvider:nil];
    double shortScore = [shortRule scoreForHostname:@"hostname"
                                           username:@"george"
                                               path:path
                                                job:@"job"
                                        commandLine:nil
